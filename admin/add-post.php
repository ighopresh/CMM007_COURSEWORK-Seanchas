...
<head>
    ...
    <title>SB Admin - Add Stories</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-10 col-lg-8 mx-auto">
                            <form action="admin-add-post-process.php" id="contactForm" method="post" enctype="multipart/form-data" name="add_post" onsubmit="return validate();">
                                ...
                                <div class="control-group">
                                    ...
                                    <input class="form-control" type="text" id="name" disabled name="name" value="<?php echo htmlentities($admin_name); ?>">
                                    </div>
                                </div>
