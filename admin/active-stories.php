...
if (isset($_REQUEST['del'])) {
    ...
    echo "<script>alert('Story DELETED successfully!');document.location = 'active-stories.php';</script>";
}
...
<head>
    ...
    <title>SB Admin - Active Stories</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Current Active Stories</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $sql = "SELECT stories.*, users.f_name, users.l_name FROM stories JOIN users WHERE users.id = stories.user_id AND stories.stat=1";
