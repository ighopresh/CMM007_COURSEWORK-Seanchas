...
<head>
   ...
   <title>Seanchas - Edit Story</title>
...
<body>
         ...
         <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-12 col-lg-12 col-xl-12" style="min-height: 5px; height: 8px;">
               <div class="site-heading">
                  <h1 style="margin-bottom: 25px;">Edit Post</h1>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-10 col-lg-8 mx-auto">
            <form action="edit-post-process.php" id="contactForm" method="post" enctype="multipart/form-data" name="add_post" onsubmit="return validate();">
   ...
   <script type="text/javascript">
      const dropArea = document.querySelector(".drag-image"),
         ...
         input = dropArea.querySelectorByClass("#file1");
      let file;
